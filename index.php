        ...
        <div id="index_main_sec1_div1">
            <article id="index_article1">
                <form method="post" name="Connexion" id="form_connexion">
                        <legend id="legend_connexion">Conneixon</legend>
                    <input aria-label="pseudo" type="text" name="c_pseudo" id="c_pseudo" placeholder="Pseudo:">
                    <input aria-label="password" type="password" name="c_password" id="c_password" placeholder="Password:">
                    <input aria-label="connexion" type="submit" name="connexion" value="Se connecter !">
                </form>
            </article>
            <article id="index_article2">
                <form method="post" name="inscription" id="form_inscription">
                    ...
                    <input aria-label="inscription" type="submit" name="inscription" value="S'inscrire !">
                </form>
            </article>
        </div>
    </section>
